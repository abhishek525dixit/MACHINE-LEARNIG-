# Gurugram House Price Prediction (90% Accuracy)

## Overview
This project implements a high-accuracy Machine Learning model to predict house prices in Gurugram, India. 
...
- `gurugram_house_prices.csv`: The dataset (from Kaggle).
